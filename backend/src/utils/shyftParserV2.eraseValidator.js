...
exports.EraseValidatorImpl = void 0;
exports.createEraseValidator = createEraseValidator;
 ...
 */
var EraseValidatorImpl = /** @class */ (function () {
    function EraseValidatorImpl() {
    }
    /**
     ...
     */
    EraseValidatorImpl.prototype.validate = function (quote, base) {
        // Rule 3: No base delta (pure quote movement)
        ...
        if (Math.abs(base.netDelta) < shyftParserV2_types_1.EPSILON) {
            return {
                isValid: false,
    ...
    return EraseValidatorImpl;
}());
exports.EraseValidatorImpl = EraseValidatorImpl;
/**
 * Factory function to create an EraseValidator instance
 */
function createEraseValidator() {
