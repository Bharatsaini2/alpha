...
exports.QuoteBaseDetectorImpl = void 0;
exports.createQuoteBaseDetector = createQuoteBaseDetector;
 ...
 */
var QuoteBaseDetectorImpl = /** @class */ (function () {
    function QuoteBaseDetectorImpl() {
    }
    /**
     ...
     */
    QuoteBaseDetectorImpl.prototype.detectQuoteBase = function (deltaMap) {
        logger_1.default.debug({ assetCount: Object.keys(deltaMap).length }, 'QuoteBaseDetector: Starting quote/base detection');
        // Filter out intermediate assets (multi-hop collapse)
        var activeAssets = Object.values(deltaMap).filter(function (asset) { return !asset.isIntermediate; });
        logger_1.default.debug({
            activeCount: activeAssets.length,
            assets: activeAssets.map(function (a) { return ({ mint: a.mint, delta: a.netDelta }); })
        }, 'QuoteBaseDetector: Active assets (non-intermediate)');
        // Gate 1: Exactly 2 assets required (Requirement 3.1)
        if (activeAssets.length !== 2) {
            logger_1.default.debug({ activeCount: activeAssets.length }, 'QuoteBaseDetector: Invalid asset count (not 2)');
            return {
                quote: null,
                base: null,
                direction: null,
        ...
        var asset1 = activeAssets[0];
        var asset2 = activeAssets[1];
        // Gate 2: Opposite delta signs required (Requirement 3.2)
        var hasOppositeSigns = (asset1.netDelta > 0 && asset2.netDelta < 0) ||
        ...
        var priorityMints = new Set(Object.values(shyftParserV2_types_1.PRIORITY_ASSETS));
        var asset1IsPriority = priorityMints.has(asset1.mint);
        var asset2IsPriority = priorityMints.has(asset2.mint);
        var hasPriorityAsset = asset1IsPriority || asset2IsPriority;
        logger_1.default.debug({
            asset1: { mint: asset1.mint, isPriority: asset1IsPriority },
            asset2: { mint: asset2.mint, isPriority: asset2IsPriority },
            hasPriorityAsset: hasPriorityAsset,
     ...
     */
    QuoteBaseDetectorImpl.prototype.detectStandardSwap = function (asset1, asset2, asset1IsPriority, asset2IsPriority) {
        var quote;
        var base;
        ...
        if (asset1IsPriority && asset2IsPriority) {
            ...
            if (asset1.mint === shyftParserV2_types_1.PRIORITY_ASSETS.SOL || asset1.mint === shyftParserV2_types_1.PRIORITY_ASSETS.WSOL) {
                quote = asset1;
                base = asset2;
            }
            else if (asset2.mint === shyftParserV2_types_1.PRIORITY_ASSETS.SOL || asset2.mint === shyftParserV2_types_1.PRIORITY_ASSETS.WSOL) {
                quote = asset2;
                base = asset1;
            }
            else {
        ...
        logger_1.default.debug({ direction: direction }, 'QuoteBaseDetector: Direction determined');
        return {
            quote: quote,
            base: base,
            direction: direction,
     ...
     */
    QuoteBaseDetectorImpl.prototype.detectSplitSwap = function (asset1, asset2) {
    ...
    return QuoteBaseDetectorImpl;
}());
exports.QuoteBaseDetectorImpl = QuoteBaseDetectorImpl;
/**
 * Factory function to create QuoteBaseDetector instance
 */
function createQuoteBaseDetector() {
