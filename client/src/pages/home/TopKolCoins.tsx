        ...
        <div className="row">
          <div className="col-lg-12 new-mobile-spacing">
            <div className="last-refreshed-bx mb-2">
              <h6>
                Last refreshed: <span className="refresh-title">21s</span>
              </h6>
              <a href="javscript:void(0)" className="refresh-btn">

                <TfiReload className="reload-btn" /> Refresh
              </a>
            </div>
              ...
              <div className="d-flex align-items-center gap-2 mob-search-bx">
                ...
                <div className="d-flex align-items-center gap-3 market-container mob-market-box">
                  ...
                  <div className="time-filter">
                    <a href="#" className="time-item active">
                      4H
                    </a>
                    <span className="divider">|</span>
                    <a href="#" className="time-item">
                      12H
                    </a>
                    <span className="divider">|</span>
                    <a href="#" className="time-item">
            ...
            <div className="tab-content custom-tab-content">
              {activeView === "table" && (
                <>
                    ...
                    <table className="table crypto-table align-middle mb-0 crypto-sub-table">
                      ...
                      <tbody>
                        ...
                        >
                          ...
                          <td>
                            <span className="sold-title">+ $100.2</span>
                          </td>
                          <td>2</td>
                          <td>$100.2</td>
                        </tr>
                        ...
                        <tr
                          className="main-row"
                          onClick={() => setOpenRow(openRow === 4 ? null : 4)}
                        >
                          <td className="expand-col">
                            {openRow === 4 ? (
                              <HiChevronUp />
                        ...
                        <tr
                          className="main-row"
                          onClick={() => setOpenRow(openRow === 5 ? null : 5)}
                        >
                          <td className="expand-col">
                            {openRow === 5 ? (
                              <HiChevronUp />
                        ...
                        <tr
                          className="main-row"
                          onClick={() => setOpenRow(openRow === 6 ? null : 6)}
                        >
                          <td className="expand-col">
                            {openRow === 6 ? (
                              <HiChevronUp />
                        ...
                        <tr
                          className="main-row"
                          onClick={() => setOpenRow(openRow === 7 ? null : 7)}
                        >
                          <td className="expand-col">
                            {openRow === 7 ? (
                              <HiChevronUp />
                        ...
                        <tr
                          className="main-row"
                          onClick={() => setOpenRow(openRow === 8 ? null : 8)}
                        >
                          <td className="expand-col">
                            {openRow === 8 ? (
                              <HiChevronUp />
                        ...
                        <tr
                          className="main-row"
                          onClick={() => setOpenRow(openRow === 9 ? null : 9)}
                        >
                          <td className="expand-col">
                            {openRow === 9 ? (
                              <HiChevronUp />
                        ...
                        <tr
                          className="main-row"
                          onClick={() => setOpenRow(openRow === 10 ? null : 10)}
                        >
                          <td className="expand-col">
                            {openRow === 10 ? (
                              <HiChevronUp />
                        ...
                        <nav>
                          <ul className="pagination crypto-pagination mb-0">
                            <li className="page-item">
                              <button className="page-link crypto-page-btn">
                                <IoChevronBack />
                                PREVIOUS
                              </button>
                            </li>
                            ...
                            <li className="page-item ">
                              <span className="page-link crypto-page-btn">
                                …
                              </span>
                            </li>
                  ...
                  <div>
                    <div className="mobile-new-table new-mobile-cards">
                      <div className="crypto-box">
                        <div className="crypto-row">
                          <div className="crypto-left">
                            <span className="crypto-title">Rank:</span>
                          </div>

                          <div className="crypto-right">
                            <span className="crypto-data">#1</span>
                          </div>
                        </div>

                        <div className="crypto-row crypto-head">
                          <div className="crypto-left">
                            <span className="crypto-title">COIN:</span>
                          </div>
                        ...
                        <div className="crypto-row">
                          <div className="crypto-left">
                            <span className="crypto-title">Net Inflow:</span>
                          </div>

                          <div className="crypto-right">
                            <span className="crypto-profit">
                              + $2,000 (+12%)
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="crypto-row">
                          <div className="crypto-left">
                            <span className="crypto-title">Whale:</span>
                          </div>

                          <div className="crypto-right">
                            <span className="crypto-data">2</span>
                          </div>
                        </div>
                        <div className="crypto-row">
                          <div className="crypto-left">
                            <span className="crypto-title">Market cap:</span>
                          </div>

                          <div className="crypto-right">
                            <span className="crypto-data">$150.7</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="crypto-dropdown">
                        <div>
                          <div className="mobile-tp-title">
                            <p>KOL ACTIVITY last 24h</p>
                          </div>

                          <div className="mobile-crypto-profile">
                            <div className="whale-card-header">
                              <div className="whale-card-icon new-mobile-whale-pic">
                                <img
                                  src="/file-second.png"
                                  alt="ETH"
                                />
                              ...
                              <div className="whale-card-info">
                                ...
                                <div>
                                  <button className="mobile-table-quick-btn">quick buy</button>
                                </div>
                              </div>
                            </div>

                            <div className="mobile-mode-spacing">
                              <div className="whale-stats-box">
                                <div className="whale-stat-row">
                                  <span className="whale-stat-label">
                                    TOTAL BUYS:
                                ...
                                <div className="whale-stat-row mobile-whale-stat-border">
                                  <span className="whale-stat-net">
                                    NET INFLOW:
                                  </span>
                                  <p className="whale-stat-value green">
                            ...
                            <div>
                              <div className="crypto-table-mobile-ui">
                                <table className="table crypto-table align-middle mb-0 crypto-mobile-table">
                                  <thead>
                                    <tr>
                                      <th>
                                        <div className="coin-th-title">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>
                                        <div className="mobile-big-bx">
                                          <span className="big-mb-title">Big Launchcoin Whale</span>
                                          <span className="extra-mobile-title">
                                            (3a6...)
                                          </span>
                                        </div>
                                      </td>
                    ...
                    <div className="mobile-new-table">
                      <div className="crypto-box">
                        ...
                        <div className="crypto-row">
                          ...
                          <div className="crypto-right">
                            <span className="crypto-profit">+ $50.5</span>
                          </div>
                        </div>
                        ...
                        <div className="crypto-row">
                          ...
                          <div className="crypto-right">
                            <span className="crypto-data">3</span>
                          </div>
                        </div>
                        <div className="crypto-row">
                          <div className="crypto-left">
                    ...
                    <div className="mobile-block">
                      ...
                      <div>
                        <nav>
                          <ul className="pagination crypto-pagination mb-0 justify-content-between">
                            <li className="page-item">
                              <button className="page-link crypto-page-btn">
                                <IoChevronBack />
                                PREVIOUS
