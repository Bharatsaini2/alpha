            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1.5 text-xs">
                        ...
                        <span className="text-white font-semibold">1.00%(Auto)</span>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex flex-col items-end gap-1">
                        <button className="flex items-center gap-2 bg-[#1A1A1E] hover:bg-[#252528] px-3 py-2 rounded-lg transition-colors border border-[#2A2A2D]">
                            <div className="w-5 h-5 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-[8px] text-white font-bold">$</div>
            ...
            <div className="bg-[#0A0A0B] rounded-lg p-4 mt-2 mb-4 border border-[#2A2A2D]">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <button className="flex items-center gap-2 bg-[#1A1A1E] hover:bg-[#252528] px-3 py-2 rounded-lg transition-colors border border-[#2A2A2D]">
                        {selectedToken ? (
                            <>
                                <img src={selectedToken.image || DefaultTokenImage} alt={selectedToken.symbol} className="w-5 h-5 rounded-full" onError={(e) => { e.currentTarget.src = DefaultTokenImage }} />
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className={`text-[10px] px-1.5 py-0.5 rounded font-semibold ${coin.positive ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'}`}>
                                        {coin.change}
                                    </span>
                                </div>
