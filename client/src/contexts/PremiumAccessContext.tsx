...
export const PremiumAccessProvider: React.FC<PremiumAccessProviderProps> = ({ children }) => {
    ...
    const validateAccess = useCallback(async (onSuccess: () => void) => {
        if (!wallet.connected) {
        ...
        <PremiumAccessContext.Provider value={{ validateAccess }}>
            ...
            <SwapModal
                ...
                initialOutputToken={{
                    ...
                    decimals: 6,
                    image: 'https://dd.dexscreener.com/ds-data/tokens/solana/3wtGGWZ8wLWW6BqtC5rxmkHdqvM62atUcGTH4cw3pump.png'
                }}
            />
